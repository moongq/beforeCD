...
export declare class BalanceGameResolver {
    ...
    TESTcreateBalanceGame(token: UserJwt, imageOfSelection0: FileUpload, imageOfSelection1: FileUpload, createBalanceGameInput: CreateBalanceGameInput): Promise<BalanceGame>;
